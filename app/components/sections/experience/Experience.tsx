              ...
              <div className="flex flex-wrap gap-2">
                {exp.technologies.map((tech) => {
                  ...
                  return (
                    <span
                      key={tech}
                      className="inline-flex items-center justify-center gap-1.5 rounded-3xl border border-blue-400/20 bg-blue-400/10 px-4 py-2 text-xs font-semibold text-blue-400"
                    >
