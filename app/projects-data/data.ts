...
export const projects: Project[] = [
  {
    ...
    thumbnail: "/projects/fullstack/mediflow/1-login.webp",
    images: [
      "/projects/fullstack/mediflow/1-login.webp",
      "/projects/fullstack/mediflow/2-dashboard-admin.webp",
      "/projects/fullstack/mediflow/3-usuarios-admin.webp",
      "/projects/fullstack/mediflow/4-auditorias-admin.webp",
      "/projects/fullstack/mediflow/5-graficos-admin.webp",
      "/projects/fullstack/mediflow/6-especialidades-admin.webp",
      "/projects/fullstack/mediflow/7-agenda-secretary.webp",
      "/projects/fullstack/mediflow/8-calendario-secretary.webp",
      "/projects/fullstack/mediflow/9-pacientes-secretary.webp",
      "/projects/fullstack/mediflow/10-detalle-paciente-secretary.webp",
      "/projects/fullstack/mediflow/11-facturacion-secretary.webp",
      "/projects/fullstack/mediflow/12-reportes-secretary.webp",
      "/projects/fullstack/mediflow/13-agenda-professional.webp",
      "/projects/fullstack/mediflow/14-horarios-semanales-professional.webp",
      "/projects/fullstack/mediflow/15-dias-no-laborales-professional.webp",
      "/projects/fullstack/mediflow/16-turno-en-atencion-professional.webp",
      "/projects/fullstack/mediflow/17-dashboard-patient.webp",
      "/projects/fullstack/mediflow/18-nuevo-turno-patient.webp",
      "/projects/fullstack/mediflow/19-listado-turnos-patient.webp",
    ],
    metrics: [
...

  {
    ...
    categories: ["Fullstack"],
    thumbnail: "/projects/fullstack/medicalHealt/1-login.webp",
    images: [
      "/projects/fullstack/medicalHealt/1-login.webp",
      "/projects/fullstack/medicalHealt/2-sign-up.webp",
      "/projects/fullstack/medicalHealt/3-dashboard-admin.webp",
      "/projects/fullstack/medicalHealt/4-users-admin.webp",
      "/projects/fullstack/medicalHealt/5-edit-user-admin.webp",
      "/projects/fullstack/medicalHealt/6-services-admin.webp",
      "/projects/fullstack/medicalHealt/7-affiliates-admin.webp",
      "/projects/fullstack/medicalHealt/8-affiliates-edit-admin.webp",
      "/projects/fullstack/medicalHealt/9-affiliates-filters-admin.webp",
      "/projects/fullstack/medicalHealt/10-orders-admin.webp",
      "/projects/fullstack/medicalHealt/11-audits-admin.webp",
      "/projects/fullstack/medicalHealt/12-audit-details-admin.webp",
      "/projects/fullstack/medicalHealt/13-stats-admin.webp",
      "/projects/fullstack/medicalHealt/14-services-operator.webp",
      "/projects/fullstack/medicalHealt/15-pharmacy-medications-operator.webp",
      "/projects/fullstack/medicalHealt/16-affiliate-access.webp",
      "/projects/fullstack/medicalHealt/17-affiliate-services.webp",
      "/projects/fullstack/medicalHealt/18-affiliate-turn-success.webp",
      "/projects/fullstack/medicalHealt/19-turn-screen.webp",
    ],
    metrics: [
      { value: "Feature First", label: "Arquitectura", color: "purple", icon: "flask" },
      { value: "15 Dominios", label: "Módulos Funcionales", color: "blue", icon: "globe" },
      { value: "3 Roles", label: "Control de Acceso", color: "orange", icon: "users" },
      { value: "Pusher", label: "Sincronización Realtime", color: "green", icon: "check" },
    ],
    intro: [
    ...
    engineering: [
      ...
      {
        title: "Autenticación con NextAuth.js y RBAC personalizado",
        paragraphs: [
          "La autenticación se implementó con NextAuth.js v4 usando CredentialsProvider, validando credenciales contra la base de datos mediante bcryptjs y manteniendo la sesión del usuario en un JWT firmado.",
          "Al estar los usuarios almacenados directamente en PostgreSQL vía Prisma, no fue necesario recurrir a servicios externos ni webhooks de sincronización. El modelo User incluye el rol y las relaciones necesarias para el sistema de permisos, manteniendo toda la lógica de autenticación dentro del mismo código base.",
          "Sobre esta base se construyó un sistema RBAC jerárquico con tres roles (ADMIN, SUPERVISOR, OPERATOR), implementado mediante un middleware centralizado con withAuth que protege rutas por rol y redirige dinámicamente según el perfil del usuario.",
        ],
      },
      {
    ...
    architecture: [
      ...
      "La autenticación utiliza NextAuth.js con CredentialsProvider y sesiones JWT, almacenando los usuarios directamente en la base de datos mediante Prisma. La autorización se resuelve mediante un sistema RBAC propio con middleware centralizado que protege rutas por rol. El proyecto incluye 6 scripts de seed reproducibles que permiten levantar un entorno funcional de forma consistente.",
    ],
    quality: [
...

  {
    ...
    categories: ["Nextjs"],
    thumbnail: "/projects/personales/hard360/1-hero.webp",
    images: [
      "/projects/personales/hard360/1-hero.webp",
      "/projects/personales/hard360/4-categories-menu.webp",
      "/projects/personales/hard360/2-notebooks.webp",
      "/projects/personales/hard360/3-screens.webp",
      "/projects/personales/hard360/5-categories-notebooks.webp",
      "/projects/personales/hard360/6-notebook-details.webp",
      "/projects/personales/hard360/7-notebook-specs.webp",
      "/projects/personales/hard360/8-cart.webp",
    ],
    metrics: [
      { value: "Modular por Dominio", label: "Arquitectura", color: "purple", icon: "flask" },
      { value: "15 Dominios", label: "Módulos Funcionales", color: "blue", icon: "globe" },
      { value: "Filtros Dinámicos", label: "Navegación Contextual", color: "orange", icon: "filter" },
      { value: "Ts Estricto", label: "Código Tipado", color: "green", icon: "check" },
    ],
    intro: [
...

  {
    ...
    thumbnail: "/projects/fullstack/vivarium/1-hero.webp",
    images: [
      "/projects/fullstack/vivarium/1-hero.webp",
      "/projects/fullstack/vivarium/2-products.webp",
      "/projects/fullstack/vivarium/3-product-details.webp",
      "/projects/fullstack/vivarium/4-category.webp",
      "/projects/fullstack/vivarium/5-login.webp",
      "/projects/fullstack/vivarium/6-dashboard-admin.webp",
      "/projects/fullstack/vivarium/7-modal-edit-admin.webp",
    ],
    metrics: [
      { value: "Layered Stack", label: "Arquitectura", color: "purple", icon: "flask" },
      { value: "7 Dominios", label: "Módulos Funcionales", color: "blue", icon: "globe" },
      { value: "NextAuth", label: "Control de Acceso", color: "orange", icon: "users" },
    ...
    engineering: [
      {
        title: "Sistema de categorías dinámico",
        paragraphs: [
          "El catálogo se organiza mediante un sistema de categorías persistidas en MongoDB, donde nuevas categorías agregadas desde el panel administrativo impactan automáticamente sobre la navegación sin necesidad de modificar código.",
          "Esta decisión permite que el cliente estructure y reorganice el catálogo según las necesidades del negocio, evitando hardcode y favoreciendo escalabilidad. La navegación se construye dinámicamente a partir de los datos almacenados, reflejando al instante cualquier cambio estructural.",
        ],
      },
      {
        title: "Adaptación a cambios del modelo de negocio",
        paragraphs: [
          "Inicialmente el proyecto incorporó compra online integrada con MercadoPago. Sin embargo, al evolucionar el modelo comercial del vivero hacia ventas bajo demanda, el flujo de checkout fue deshabilitado por pedido del cliente y reemplazado por contacto directo vía WhatsApp.",
          "La integración con MercadoPago fue diseñada utilizando Checkout + Webhooks con validación de firma HMAC, desacoplando el flujo de pagos del resto del sistema. Esto permitió deshabilitar temporalmente la compra online sin afectar el catálogo ni el panel administrativo, manteniendo la posibilidad de reactivar la funcionalidad en el futuro sin rediseñar la plataforma.",
        ],
      },
      {
    ...
    architecture: [
      "La aplicación fue desarrollada utilizando Next.js con App Router, TypeScript y base de datos MongoDB, organizando las rutas mediante Route Groups ((public) y (private)) para separar claramente la experiencia del visitante del panel administrativo del propietario.",
    ...
    quality: [
      ...
      "Categorías dinámicas desde MongoDB",
...

  {
    ...
    categories: ["Freelance", "Nextjs", "Fullstack"],
    thumbnail: "/projects/fullstack/apex/1.webp",
    images: [
      "/projects/fullstack/apex/1.webp",
      "/projects/fullstack/apex/2.webp",
      "/projects/fullstack/apex/3.webp",
    ],
    metrics: [
      { value: "Layered Stack", label: "Arquitectura", color: "purple", icon: "flask" },
      { value: "4 Módulos", label: "Dominios Funcionales", color: "blue", icon: "globe" },
      { value: "Google Auth", label: "Control de Acceso", color: "orange", icon: "users" },
      { value: "9 Tests", label: "Calidad", color: "green", icon: "check" },
    ],
    intro: [
    ...
    features: [
      ...
      },
      {
        ...
        list: [
          "Control de acceso mediante autenticación con Google.",
          "Sesiones seguras.",
        ],
      },
    ],
...

  {
    ...
    categories: ["Freelance", "Nextjs", "Fullstack"],
    thumbnail: "/projects/fullstack/kassTienda/1.webp",
    images: [
      "/projects/fullstack/kassTienda/1.webp",
      "/projects/fullstack/kassTienda/2.webp",
      "/projects/fullstack/kassTienda/3.webp",
      "/projects/fullstack/kassTienda/4.webp",
      "/projects/fullstack/kassTienda/5.webp",
    ],
    metrics: [
      ...
      { value: "SSR Nativo", label: "Server Components", color: "orange", icon: "globe" },
    ],
    intro: [
...

  {
    ...
    images: [
      "/projects/fullstack/movix/1.webp",
      "/projects/fullstack/movix/2.webp",
      "/projects/fullstack/movix/3.webp",
      "/projects/fullstack/movix/4.webp",
    ],
    metrics: [
...

  {
    ...
    categories: ["Nextjs"],
    thumbnail: "/projects/fullstack/gamehub/1.webp",
    images: [],
...

  {
    ...
    categories: ["React"],
    thumbnail: "/projects/fullstack/adminRecharts/1.webp",
    images: [
      "/projects/fullstack/adminRecharts/1.webp",
      "/projects/fullstack/adminRecharts/2.webp",
      "/projects/fullstack/adminRecharts/3.webp",
      "/projects/fullstack/adminRecharts/4.webp",
    ],
    metrics: [
      { value: "Nested Routes", label: "Arquitectura", color: "blue", icon: "flask" },
